...
function calcularPromedio(fila) {
    ...
    document.getElementById("promedio").value = promedio.toFixed(1) + " (" + Letras(Math.floor(promedio)) + " punto " + Letras(parseInt((promedio % 1) * 10)) + ") ";
...
// do while "hay que cambiar la funcion del for a un do while para la busqueda de datos"
    if (!encontrada) {
        ...
        document.getElementById("notas4").value = "";
